...
namespace Points{
    ...
    double getDist(Point const &p1, Point const &p2){
...
namespace Figures{
    ...
    void sortTrianglesByArea(Triangle * const triangles, size_t const N){
    ...
    void printTriangle(Triangle const &triangle){
